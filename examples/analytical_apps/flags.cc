...
DEFINE_bool(cilk, true, "use cilk");
DEFINE_bool(verify, false, "verify correctness of result");
DEFINE_int32(master_degree, 0, "set to the threshold of the degree of the mirror vertex");
...
DEFINE_double(pr_tol, 1, "pr tolerance");
...
DEFINE_double(termcheck_value_threshold, 0, "");
DEFINE_bool(d2ud_weighted, false, "output weight");
DEFINE_double(step, 0,"");
