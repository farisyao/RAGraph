...
class FragmentBase {
 public:
  ...
  /**
   * @brief Returns the number of master vertices in this fragment.
   *
   * @return The number of vertices in this fragment.
   */
  virtual size_t GetMasterVerticesNum() const = 0;
  ...
  /**
   * @brief Returns the degree of inner or master vertex v in this fragment.<Paste>
   *
   * @param v Input vertex.
   *
   * @return inner or master vertex degree of vertex v in this fragment.
   */
  virtual int GetLocalDegree(const Vertex<VID_T>& v) const = 0;
